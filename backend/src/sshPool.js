...
class LocalExecutor {
  ...
  async exec(command, options = {}) {
    ...
    ;['POSTGRES_PORT', 'POSTGRES_PASSWORD', 'POSTGRES_HOST', 'POSTGRES_USER', 'POSTGRES_DB', 'JWT_SECRET', 'JWT_JWKS', 'ADMIN_PASSWORD', 'LOCAL_JWT_SECRET', 'ADMIN_EMAIL', 'COOKIE_SECRET', 'PORT'].forEach(k => delete cleanEnv[k])
